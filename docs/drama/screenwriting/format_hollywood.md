---
nav_path_prefix: Drama > Screenwriting >
---
...
所有参考文件均来自 [BBC Writersroom](https://www.bbc.co.uk/writers/)：
...
场景动作在标题下方使用 **两倍行距**，**文本大小写混合**，**段落之间也采用双倍行距**。
...
转场效果通常只用于拍摄剧本（Shooting Script）中，但如果绝对有必要指定，它需要 **全大写并附带冒号**，**居右** 显示。
...
常见的转场包括 `CUT TO` ，`DISSOLVE TO`，`MATCH CUT TO`，`JUMP CUT TO` 等等。
